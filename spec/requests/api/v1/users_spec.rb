...
#       expect(json[0]["id"]).to eq User.last.id
#       expect(json[0]["first_name"]).to eq User.last.first_name
#       expect(json[0]["last_name"]).to eq User.last.last_name
#       expect(json[0]["age"]).to eq User.last.age
#       expect(json[0]["company"]).to eq User.last.company
#       expect(json[0]["email"]).to eq User.last.email
#       expect(json[0]["phone_number"]).to eq User.last.phone_number
#       expect(json[0]["twitter"]).to eq User.last.twitter
#       expect(json[0]["message"]).to eq User.last.message
#       expect(json[0]["gender"]).to eq User.last.gender
#     end
#   end
...
#     context 'when a parameter is valid' do
